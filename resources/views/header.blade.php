            ...
            <div class="d-flex px-0 align-items-center">
                <ul class="nav">
                    <li class="nav-item d-flex" style="margin-right: 10px;">
                        <div class="d-flex align-items-center"><i class="fa fa-phone px-1" style="font-size: 18px; color:#fd850d" aria-hidden="true"></i></div>
            ...
            <div class="container">
                <ul class="nav w-100 d-flex justify-content-center">
                    ...
                    <li class="nav-item dropdown">
                        <a href="{{ env('APP_URL').'/uchebniy-proces'}}" class="nav-link link-dark link-opacity-25-hover px-2 " id="teachprocess">
                            Учебный процесс
                        </a>
                        <ul class="p-0 py-2 drop-link" style="z-index: 1000; width: 150px; overflow-wrap:break-word;">
                            ...
                            <li><a class="dropdown-item" href="{{ env('APP_URL').'/meroptiatiya'}}">Мероприятия</a></li>
                        </ul>
                    </li>

...
<div class="container radius-content py-4 px-4">
    ...
    <div class="w-100 d-flex justify-content-center"><img src="../build/imgs/logo.jfif" style="width: 420px; height: 400px" alt=""></div>
    <div class="d-flex">
    ...
    <script type="text/javascript" charset="utf-8" async src="https://api-maps.yandex.ru/services/constructor/1.0/js/?um=constructor%3A6d286e6b0af4c0c0ba33cdc5aec42e3b24a600378571a509888971e4e98f6625&amp;width=800&amp;height=450&amp;lang=ru_RU&amp;scroll=true"></script>    </div>
</div>
@include ('footer')
